...
function parseTerritory(value: string | null): string | undefined | null {
  ...
  // merita di sapere che per la povertà assoluta il dettaglio regionale non
  // esiste, non un generico "parametro malformato".
...
export function GET(request: NextRequest) {
  ...
  // Senza filtri la risposta sarebbe l'intera serie: la superficie resta limitata
  // per contratto e si rifiuta invece di servirla, come per le altre fonti.
  ...
  try {
    return Response.json(queryIstatPovertaAssoluta({ territory, year, measure }), {
