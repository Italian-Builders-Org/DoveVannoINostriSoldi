...
export function siopeProjectionMeasurements(value: unknown) {
  ...
  if (!Number.isSafeInteger(rows + 19_689_670) || !Number.isSafeInteger(bytes + 3_658_177_879)) {
...
export const INTEGRATED_CORPUS_CONTRACT = {
  ...
  sourceRows: 19_689_670 + siopeRows,
  publicRows: 6_707_324 + siopeRows,
  catalogOnlyRows: 12_979_505,
  derivedOnlyRows: 2_841,
  sourceBytes: 3_658_177_879 + siopeBytes,
} as const;
