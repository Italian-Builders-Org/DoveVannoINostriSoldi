...
test("SIOPE refresh measurements vary without changing other corpus contributions", () => {
  ...
  assert.equal(INTEGRATED_CORPUS_CONTRACT.sourceRows - before.rows, 13_992_842);
  assert.equal(INTEGRATED_CORPUS_CONTRACT.publicRows - before.rows, 1_010_496);
  assert.equal(INTEGRATED_CORPUS_CONTRACT.sourceBytes - before.bytes, 2_865_992_059);
