...
import { queryOpenCivitas2021Polizia } from "@/lib/opencivitas-2021-polizia-snapshot";
...
export function GET(request: NextRequest) {
  ...
  if (year !== null && year !== "2021") {
    return Response.json(
      { error: "Questo endpoint serve solo l'annualità 2021 FC70POLIZIA. I servizi totali 2021 restano su /api/spese/opencivitas-2021." },
      { status: 400, headers: { "Cache-Control": "no-store" } },
    );
  }
