...
const datasetDescriptors: DatasetDescriptorInput[] = [
  ...
  { id: "openbdap_spesa_legislature", title: "Spesa dello Stato per legislatura", summary: "Confronto descrittivo tra l'anno pre-elettorale e la media degli altri anni completi di ogni legislatura chiusa, più gli anni completi già pubblicati della legislatura in corso, sulla spesa OpenBDAP RGS per missione (2014-2025).", sourceIds: ["openbdap"], freshness: "live", filters: [], caveat: "Confronto puramente descrittivo, non un test di significatività statistica: due sole legislature complete osservate, la spesa statale cresce anche per motivi non elettorali (trend, inflazione) e il 2020-2021 include la spesa emergenziale COVID-19, dichiarata esplicitamente. La legislatura in corso espone gli anni solari completi già in catalogo senza anno pre-elettorale né media. Non implica causalità né intento elettorale, non copre spesa comunale, regionale o europea." },
