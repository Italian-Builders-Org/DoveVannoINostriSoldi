...
import { queryOpenCivitas2021Rifiuti } from "@/lib/opencivitas-2021-rifiuti-snapshot";
...
export function GET(request: NextRequest) {
  ...
  if (year !== null && year !== "2021") {
    return Response.json(
      { error: "Questo endpoint serve solo l'annualità 2021 FC70RIFIUTI. I servizi totali 2021 restano su /api/spese/opencivitas-2021; i rifiuti 2022 su /api/spese/opencivitas-2022-rifiuti." },
      { status: 400, headers: { "Cache-Control": "no-store" } },
    );
  }
