...
| Difesa: funzione COFOG e missione Stato | Implementata nella PR collegata: Eurostat GF02 2014-2024 e stanziamenti CP A1 2017-2026 separati; collegamento dalla home, fonti e caveat NATO/missioni estere | Sì | Basso | [#365](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/365) | `/spese/difesa` | Completare review e gate prima del merge. Nessuna somma fra fonti; dettagli per missione estera richiedono dati propri. |
...
| Politici: proposte firmate, iter e voto finale | Camera XIX in questa PR: snapshot SPARQL verificato (atti, cofirme, iter, votazioni finali e voti nominali), contratto, sezione nel profilo e API; Senato follow-up | Sì | Medio | [#545](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/545) | `/politici`, `/api/politici/[id]/atti`, [CAMERA_ATTI_VOTI.md](CAMERA_ATTI_VOTI.md) | Review e merge della PR; poi adapter Senato su dati.senato.it con ontologia diversa. |
