...
export function siopeProjectionMeasurements(value: unknown) {
  ...
  if (!Number.isSafeInteger(rows + 13_992_842) || !Number.isSafeInteger(bytes + 2_865_992_059)) {
...
export const INTEGRATED_CORPUS_CONTRACT = {
  ...
  sourceRows: 13_992_842 + siopeRows,
  publicRows: 1_010_496 + siopeRows,
  catalogOnlyRows: 12_979_505,
  derivedOnlyRows: 2_841,
  sourceBytes: 2_865_992_059 + siopeBytes,
} as const;
