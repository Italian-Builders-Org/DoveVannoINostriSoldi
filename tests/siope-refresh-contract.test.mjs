...
test("SIOPE refresh measurements vary without changing other corpus contributions", () => {
  ...
  assert.equal(INTEGRATED_CORPUS_CONTRACT.sourceRows - before.rows, 19_846_281);
  assert.equal(INTEGRATED_CORPUS_CONTRACT.publicRows - before.rows, 6_863_935);
  assert.equal(INTEGRATED_CORPUS_CONTRACT.sourceBytes - before.bytes, 3_718_428_533);
