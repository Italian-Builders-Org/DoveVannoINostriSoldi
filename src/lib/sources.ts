...
export const publicSources: PublicSource[] = [
  ...
  {
    slug: "eurostat",
    name: "Eurostat · contabilità nazionale e IPCA",
    owner: "Eurostat",
    area: "Interessi sul debito e costo della vita",
    cadence: "Mensile per IPCA; annuale per contabilità nazionale",
    coverage: "Italia e peer UE dal 2022 per IPCA; Italia, ultimi cinque anni comuni per D41PAY e TE",
    ...
    note: "Ogni risultato mantiene dataset, unità e periodo: l'IPCA mensile descrive i prezzi ma non attribuisce causalmente il loro andamento al governo; la quota interessi è una derivazione aritmetica.",
    joinKeys: ["dataset", "periodo", "geo", "voce"],
  },
  {
    slug: "siope",
    name: "SIOPE / SIOPE+",
