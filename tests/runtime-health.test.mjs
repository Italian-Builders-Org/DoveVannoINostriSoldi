...
const SOURCE_IDS = [
  ...
  "pcm", "partecipazioni-pubbliche", "bancaditalia", "eurostat", "eurostat-hicp", "oecd-taxing-wages", "eurostat-cofog", "istat-cofog", "istat-epea", "istat-poverta", "istat-poverta-relativa", "istat-bes-economico", "istat-bes-salute", "istat-bes-istruzione", "inps-naspi", "mef-irpef-dettaglio", "ameco",
  "governi-presidenza",
  "mef-iva",
];
const MCP_HEADERS = {
