...
import { istatPovertaRegioniData } from "@/lib/istat-poverta-regioni-snapshot";
...
const exhaustiveLatestDataBySlug = {
  ...
  "eurostat-gdp": {
    kind: "period",
    label: `PIL Italia ${eurostatGdpData.period.quarterly.from}/${eurostatGdpData.period.quarterly.to}; annuale ${eurostatGdpData.period.annual.from}-${eurostatGdpData.period.annual.to}`,
  },
  "oecd-taxing-wages": {
    kind: "period",
  ...
  "istat-poverta-regioni": {
    kind: "period",
    label: `${istatPovertaRegioniData.period.from}-${istatPovertaRegioniData.period.to}`,
  },
  "eurostat-arope": {
    kind: "period",
