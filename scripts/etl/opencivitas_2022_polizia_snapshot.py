#!/usr/bin/env python3
"""Pinned FC80POLIZIA 2022 release — Polizia locale function, not total services."""
...
SPEC_PATH = Path(__file__).with_name("specs") / "opencivitas-2022-polizia.source.json"
SPEC = json.loads(SPEC_PATH.read_text(encoding="utf-8"))
OUTPUT = Path("src/data/generated/opencivitas-2022-polizia.json")
# Filled after the first verified build; --check pins the immutable artifact.
SEMANTIC_SHA256 = "16f7ee746b7df675b3bc9f2bbbb3eb18496634fa37e4074232467c235e56f1be"
...
def load_raw_data(payload: bytes) -> dict[str, dict[str, dict[str, str]]]:
    """FC80POLIZIA CSV includes Privacy (unlike FC80RIFIUTI)."""
...
def normalize(data: bytes, entities: bytes, indicators: bytes, observed_at: str) -> dict:
    ...
    return {
        ...
        "source": {
            ...
            "dataset": "Comuni · Polizia locale · Indicatori e determinanti 2022 (FC80POLIZIA)",
        ...
        "methodology": {
            ...
            "functionSeparationWarning": "FC80POLIZIA 2022 è distinto da FC80TOT 2022, FC80RIFIUTI 2022, FC80TERRVIAB 2022, FC80SOCNID 2022 e dalle altre funzioni: nessuna somma o confronto silenzioso fra funzioni o annualità.",
        },
    }
