    ...
    <main className="shell page">
      <header className="page-intro">
        ...
        <p className={styles.links}>
          ...
          <Link href="/spese/sanita/dispositivi">Spesa per dispositivi medici · 2020-2021 →</Link>
      ...
      <section className="panel" aria-labelledby="medical-devices-title">
        ...
        <p>Ricerca i dispositivi presenti nella spesa rilevata dalle aziende sanitarie nel 2020 e nel 2021. Puoi consultare numero di repertorio, anagrafica BD/RDM, classificazione CND e aggregati per territorio o fabbricante.</p>
