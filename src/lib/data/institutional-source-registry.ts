...
export const INSTITUTIONAL_SOURCE_REGISTRY = [
  ...
  },
  {
    ...
    downloadUrl: "https://presidenza.governo.it/AmministrazioneTrasparente/Bilanci/BilancioPreventivoConsultivo/ContoFinanziario/2024/Conto%20finanziario%202024.xlsx",
    assetId: "sha256:7944cb81a7e9f151b44bb5577d380cd8adf9671ddbebcc1ad530b91b90615603",
    format: "xlsx",
    expectedSchema: { fieldCount: 32, rowCount: 572 },
    ...
    safeUse: "Impegni e pagamenti 2024 separati, con 572 righe riconciliate e checksum del workbook.",
  },
  {
    ...
    downloadUrl: "https://bdap-opendata.rgs.mef.gov.it/export/csv/2025---Rendiconto-Pubblicato-Elaborabile-Spese-Capitolo.csv",
    ...
    safeUse: "Impegni CP, pagamenti CS e residui separati; 5.395 righe e identità contabili validate.",
  },
  {
  ...
  {
    id: "openbdap-fet-regional-budgets",
    domain: "region",
    subjectId: "regional-administrations",
    owner: "Ministero dell'economia e delle finanze - Ragioneria Generale dello Stato",
    title: "BDAP Bilanci Armonizzati delle Regioni e Province autonome",
    sourceRecordId: "openbdap:fet:bilanci-armonizzati:regioni",
    referencePeriod: "Previsione 2026; rendiconto 2024; consolidato da verificare per il comparto Regioni",
    sourceUrl: "https://openbdap.rgs.mef.gov.it/it/FET/Analizza#BilanciArmonizzati",
    downloadUrl: "https://openbdap.rgs.mef.gov.it/Datasets_FET/Rendiconto/2024/2024_Rendiconto%20-%20Schemi%20di%20bilancio.zip",
    assetId: null,
    format: "zip",
    expectedSchema: null,
    createdAt: null,
    ...
    licenseName: null,
    readiness: "metadata-only",
    accountingScope: "Bilanci armonizzati: previsione, rendiconto e consolidato restano documenti e fasi contabili distinti; non sono movimenti di cassa SIOPE.",
    safeUse: "Catalogo e link ufficiali soltanto. Nessun valore, API o MCP finché una licenza di riuso compatibile e lo schema del bulk ZIP non sono verificati.",
  },
