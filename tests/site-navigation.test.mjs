...
test("supporters page lists the current acknowledgements", async () => {
  ...
  assert.match(supporters, /11 ai compute/);
  assert.match(supporters, /HyDrogu/);
  assert.match(supporters, /chochoichoy/);
  assert.match(supporters, /GalloDaSballo/);
  assert.match(supporters, /1000 ai compute/);
  assert.match(supporters, /BoccardoReal/);
  assert.match(supporters, /Sostegni su Buy Me a Coffee \(30 ai compute\)/);
  assert.match(supporters, /Sostegni anonimi/);
  assert.match(supporters, /5 ai compute in totale/);
  assert.match(supporters, /Aggregati per nome pubblico/);
  ...
  assert.match(page, /Raggruppiamo i contributi quando il nome pubblico/);
  assert.match(page, /sostegni anonimi sono aggregati separatamente/);
