...
- **Check total coverage.** The existing hubs and surface previews retain their 84 dataset links. The three ISTAT municipal series, the MIM school-site dataset and TED notices are linked from `/dati?vista=tutti`; the combined coverage is 89 dataset IDs.
