...
| Nuove verticali: clima e sport | Sport su `main`; ambiente ancora da completare | Dipende | Fonte | [#86](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/86), [#83](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/83) | Nuove route | Una verticale alla volta, fonte primaria matura. Feedback: X-069, X-074, X-090. |
