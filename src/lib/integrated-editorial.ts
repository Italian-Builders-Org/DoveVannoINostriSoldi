...
export const EDITORIAL_TOPICS: readonly EditorialTopic[] = [
  {
    ...
    introduction: "Appalti, importi, destinatari e atti disponibili, con le lacune di copertura.",
  ...
  },
  {
    ...
    introduction: "Destinatari dei contratti, importi e documenti disponibili.",
    status: "Fatto documentato",
    primaryMetric: "682",
  ...
  },
  {
    ...
    facts: [
      { value: "0", label: "SKU confrontabili", note: "Nessun prodotto ha dati sufficienti per il confronto." },
  ...
  },
  {
    ...
    introduction: "Incarichi legali, importi dichiarati e atti disponibili.",
    status: "Fatto documentato",
    primaryMetric: "352",
    ...
    facts: [
      ...
      { value: "3.261.822,68 €", label: "totale parziale leggibile", note: "Somma del solo sottoinsieme con importo leggibile." },
  ...
  },
  {
    ...
    introduction: "Persone, ruoli, durata e compensi. I confronti curriculari restano distinti dai fatti contrattuali.",
    status: "Fatto documentato",
    primaryMetric: "1.633",
  ...
  },
  {
    ...
    introduction: "Spese per eventi: oggetto, ente, destinatario e importo, quando pubblicati.",
    status: "Fatto documentato",
    primaryMetric: "109",
  ...
  },
  {
    ...
    hubSummary: "Capitoli di missione e pagamenti 2024-2025; trasferte individuali non disponibili.",
    facts: [
  ...
  },
  {
    ...
    introduction: "Rimborsi e relativi atti ufficiali.",
    status: "Fatto documentato",
    primaryMetric: "21",
  ...
  },
  {
    ...
    datasets: [
      ...
      { id: "capitoli-consulenze-copertura", label: "Copertura dei capitoli consulenza" },
      {
        ...
        catalogBoundary: "Dettaglio per progetto non ancora consultabile: i CUP devono essere verificati prima del confronto con OpenCoesione.",
      },
      {
        id: "opencup-soggetti",
  ...
  },
  {
    ...
    introduction: "Amministrazioni e identificativi presenti nei dataset delle pagine tematiche.",
    status: "Fatto documentato",
    primaryMetric: "170",
  ...
  },
  {
    section: "controlli",
    slug: "working-set",
    title: "Casi da verificare",
    description: "Quattro lotti catalogati e mantenuti separati dalla lista editoriale delle segnalazioni.",
    introduction: "Casi da verificare, raccolti in quattro lotti. I conteggi non si sommano e non indicano sprechi accertati.",
    status: "Richiede una spiegazione",
    primaryMetric: "3.144",
    ...
    facts: [
      ...
      { value: "508", label: "lotto C", note: "Candidati da esaminare, non prove definitive." },
  ...
  },
  {
    ...
    description: "Confronti di consulenze, contratti e istituzioni con criteri espliciti di comparabilità.",
    ...
    hubSummary: "Confronti su consulenze, contratti e istituzioni, verificati per unità, anno e ambito.",
    facts: [
    ...
    datasets: [
      {
        ...
        catalogBoundary: "Oggetto, durata e unità non sono omogenei in tutte le righe: il catalogo documenta i limiti del confronto e non forma una classifica.",
      },
      {
