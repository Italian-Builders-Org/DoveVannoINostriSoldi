...
node --experimental-strip-types --import ./scripts/ci/node-test-setup.mjs --test tests/opencivitas-2021-amministrazione-contract.test.mjs tests/opencivitas-2021-amministrazione-route.test.mjs
```
