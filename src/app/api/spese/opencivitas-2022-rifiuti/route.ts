...
import { queryOpenCivitas2022Rifiuti } from "@/lib/opencivitas-2022-rifiuti-snapshot";
...
export function GET(request: NextRequest) {
  ...
  if (year !== null && year !== "2022") {
    return Response.json(
      { error: "Questo endpoint serve solo l'annualità 2022 FC80RIFIUTI. I servizi totali restano su /api/spese/opencivitas." },
      { status: 400, headers: { "Cache-Control": "no-store" } },
    );
  }
