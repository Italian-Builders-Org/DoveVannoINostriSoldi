...
const SOURCE_IDS = [
  ...
  "pcm", "partecipazioni-pubbliche", "bancaditalia", "eurostat", "eurostat-hicp", "eurostat-arope", "eurostat-gdp", "oecd-taxing-wages", "eurostat-cofog", "eurostat-gov-main", "istat-cofog", "istat-epea", "istat-poverta", "istat-poverta-relativa", "istat-poverta-soglia-assoluta", "istat-poverta-soglia-relativa", "istat-poverta-regioni", "istat-bes-economico", "istat-bes-salute", "istat-bes-istruzione",   "istat-bes-lavoro", "istat-bes-relazioni", "istat-bes-politica", "istat-bes-sicurezza", "istat-bes-paesaggio", "istat-bes-servizi", "istat-bes-ambiente", "istat-bes-innovazione", "inps-naspi", "inps-assegno-unico", "inps-integrazioni-salariali", "inps-cig-fondi-solidarieta", "inl-vigilanza", "aifa-spesa-consumi", "mef-irpef-dettaglio", "ameco",
  "governi-presidenza",
  "mef-iva",
  "eu-vat-gap-italy",
