...
import { queryOpenCivitas2021SocialeAsili } from "@/lib/opencivitas-2021-sociale-asili-snapshot";
...
export function GET(request: NextRequest) {
  ...
  if (year !== null && year !== "2021") {
    return Response.json(
      { error: "Questo endpoint serve solo l'annualità 2021 FC70SOCNID. I servizi totali 2021 restano su /api/spese/opencivitas-2021; il sociale 2022 su /api/spese/opencivitas-2022-sociale-asili." },
      { status: 400, headers: { "Cache-Control": "no-store" } },
    );
  }
  ...
  try {
    return Response.json(
      queryOpenCivitas2021SocialeAsili({
