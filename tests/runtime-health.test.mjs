...
const SOURCE_IDS = [
  ...
  "pcm", "partecipazioni-pubbliche", "bancaditalia", "eurostat", "eurostat-hicp", "eurostat-cofog", "istat-cofog", "istat-epea", "istat-poverta", "inps-naspi", "mef-irpef-dettaglio", "ameco",
  "governi-presidenza",
];
const MCP_HEADERS = {
