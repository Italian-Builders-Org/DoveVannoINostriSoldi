"""BES_07-specific SDMX parsing, coverage and provenance checks, entirely offline."""
import copy
import csv
import io
import json
...
import istat_bes_sicurezza as bes


class BesSicurezzaTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_domain_units_and_edition_are_locked(self):
        for column, bad in [("UNIT_MEAS", "EURO"), ("DOMAIN", "BES_06"), ("EDITION", "2024"),
                            ("DATAFLOW", "IT1:DF_BES_TERRIT_6(1.0)")]:
    ...
    def test_null_unknown_absent_row_and_observed_zero_stay_distinct(self):
        ...
        self.assertEqual(flagged[0], {
            "indicator": "07SIC008P", "territory": "ITG2B", "sex": "T", "year": 2013,
            "valueTenths": None, "status": "g",
        })
