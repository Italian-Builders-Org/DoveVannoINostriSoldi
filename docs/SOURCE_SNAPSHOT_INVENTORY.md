...
- manuale: 34 (PR umana dopo revisione)
...
| `siope-nonmunicipal` | 2024-2026 | 2026-09-07T00:11:56+00:00 | https://www.siope.it/documenti/siope2/open/last | `17 5 8 * *` | `.github/workflows/siope-nonmunicipal-refresh.yml` | PR automatica | `python3 scripts/ci/check-siope-nonmunicipal-refresh.py` |
