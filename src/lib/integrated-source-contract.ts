...
export function siopeProjectionMeasurements(value: unknown) {
  ...
  if (!Number.isSafeInteger(rows + 18_056_224) || !Number.isSafeInteger(bytes + 3_497_087_967)) {
...
export const INTEGRATED_CORPUS_CONTRACT = {
  ...
  sourceRows: 18_056_224 + siopeRows,
  publicRows: 5_073_878 + siopeRows,
  catalogOnlyRows: 12_979_505,
  derivedOnlyRows: 2_841,
  sourceBytes: 3_497_087_967 + siopeBytes,
} as const;
