        ...
        <section className="panel" aria-labelledby="municipal-screening-title">
              ...
              >
                <table className="table">
                  <caption>
                    ...
                    {" "}risultati dello screening, ordinati per distanza dalla soglia per
                    facilitare la lettura · OpenCivitas {openCivitasSnapshot.referenceYear}
                  </caption>
                  <thead>
                    <tr>
          ...
          <details className={styles.signalDetails}>
            ...
            <div
              className={"table-scroll " + styles.outlierTable}
              role="region"
              aria-label="Controllo di sensibilità per fascia di popolazione"
              aria-describedby="sensitivity-table-hint"
              tabIndex={0}
            >
              <table className="table">
