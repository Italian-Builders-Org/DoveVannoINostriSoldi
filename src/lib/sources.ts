...
export const publicSources: PublicSource[] = [
  ...
  },
  {
    ...
    cadence: "Controllo giornaliero dei file; aggiornamento quando cambia la fonte",
    coverage: "Adapter attivi: incassi e pagamenti di cassa dei Comuni, 2024–2026",
    format: "ZIP · CSV · classificazioni contabili",
    url: "https://www.siope.it/documenti/siope2/open/last/",
    note: "Movimenti mensili nazionali e anagrafiche SIOPE: snapshot distinti per incassi (/entrate) e pagamenti. Il 2026 può essere parziale. Incassi non significa accertamenti; nessun saldo di bilancio o residuo fiscale viene ricostruito.",
  },
  {
    slug: "istat",
    name: "ISTAT SITUAS",
