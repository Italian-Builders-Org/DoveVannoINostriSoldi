...
import { queryOpenCivitas2021Viabilita } from "@/lib/opencivitas-2021-viabilita-snapshot";
...
export function GET(request: NextRequest) {
  ...
  if (year !== null && year !== "2021") {
    return Response.json(
      { error: "Questo endpoint serve solo l'annualità 2021 FC70TERRVIAB. I servizi totali 2021 restano su /api/spese/opencivitas-2021; la viabilità 2022 su /api/spese/opencivitas-2022-viabilita." },
      { status: 400, headers: { "Cache-Control": "no-store" } },
    );
  }
