...
import { queryIstatBesInnovazione } from "@/lib/istat-bes-innovazione-snapshot";
...
export function GET(request: NextRequest) {
  ...
  try {
    ...
    if (rawYear !== null && !/^\d{4}$/.test(rawYear)) throw new Error("Il parametro anno deve essere un anno a quattro cifre.");
    ...
    const result = queryIstatBesInnovazione({
