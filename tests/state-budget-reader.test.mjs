...
test('canonical reader: 22 cases, ten functions, preserved original case identities',()=>{assert.equal(validateReader(report),report);assert.equal(report.cases.length,22);});
