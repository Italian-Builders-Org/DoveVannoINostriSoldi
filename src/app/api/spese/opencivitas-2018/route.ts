...
import { queryOpenCivitas2018 } from "@/lib/opencivitas-2018-snapshot";
...
export function GET(request: NextRequest) {
  ...
  if (year !== null && year !== "2018") {
    return Response.json(
      { error: "Questo endpoint serve solo l'annualità 2018 FC50TOT. Le annualità 2019, 2021 e 2022 restano nei rispettivi dataset." },
      { status: 400, headers: { "Cache-Control": "no-store" } },
    );
  }
