      ...
      <div className={styles.chart} role="img" aria-label={`${leftIndicator.label}: traiettorie sovrapposte di ${left.name} e ${right.name} dall’inizio dei rispettivi mandati`}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 12, right: 18, bottom: 4, left: 5 }} accessibilityLayer>
            ...
            <Line type="monotone" dataKey="left" name={left.name} stroke="#111827" strokeWidth={3} dot activeDot={{ r: 4 }} connectNulls={false} isAnimationActive={false} />
            <Line type="monotone" dataKey="right" name={right.name} stroke="#b91c0c" strokeWidth={3} dot activeDot={{ r: 4 }} connectNulls={false} isAnimationActive={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
