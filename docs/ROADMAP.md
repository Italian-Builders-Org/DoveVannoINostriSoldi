...
| Resilienza, mirror, governance del branch | Snapshot, ADR-001 e ruleset `protect-main` su `main` ([#38](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/38) chiusa) | Sì | Alto | [#38](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/38) chiusa | [ADR-001](architecture/ADR-001-generated-artifacts-storage.md), [GOVERNANCE.md](../GOVERNANCE.md) | Runbook DR, mirror verificato, test di ripristino. Feedback: T-029, A-011. |
