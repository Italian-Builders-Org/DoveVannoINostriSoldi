 ...
 */
function JudicialBlock({ judicial }: { judicial: JudicialState | null }) {
  ...
  if (judicial.status === "error") {
    return (
      <section className={styles.judicialBlock} aria-label="Procedimenti giudiziari documentati">
        <h3 className={styles.cardSection}>Procedimenti giudiziari documentati</h3>
        <p className={styles.cardNote}>Dati non raggiungibili in questo momento.</p>
      </section>
    );
  }
