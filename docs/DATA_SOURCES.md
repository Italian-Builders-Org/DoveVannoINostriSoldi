...
2026, CC BY 4.0) entra nel corpus aggregato per ente dichiarante: 140.712 righe
di beni per titolo, stato d'uso, cessione a terzi, tipologia e comune del bene e 21.034 righe di contratti dati a
...
aggregato per ente. Vedi [lock, contratto, limiti e riproduzione](MEF_PATRIMONIO_IMMOBILIARE.md).
