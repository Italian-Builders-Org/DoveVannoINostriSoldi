...
| Cultura e tempo libero (COFOG GF08) | Implementata nella PR collegata: totale Italia 2014-2024, serie e fonte; missione culturale OpenBDAP separata; Sport resta approfondimento distinto. Non ancora merged | Sì | Medio | [#367](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/367) | `/spese/cultura` | Completare review e gate prima del merge. Le sottofunzioni non sono presenti nello snapshot, nessuna ripartizione stimata. |
