...
| `istat-poverta-soglia-relativa-2014-2024` | 2014-2024 (senza 2021) | 2026-09-21 | https://esploradati.istat.it/databrowser/ | nessuno | nessuno | manuale | `python3 scripts/etl/istat_poverta_soglia_relativa.py --check` |
