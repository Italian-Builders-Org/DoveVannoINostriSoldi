# Audit del bilancio: aggiornamento della PR #509

Base della PR ricontrollata: `a51efcf3a8f8a3a0407e09f5fda8666fb089cfce`, branch
`codex/ampliamento-report-2026`. Nessuna operazione remota. L'aggiornamento è
incrementale rispetto al pacchetto già importato: non riapplicare il vecchio ZIP.
...
22 riscontri, di cui 17 già presenti e cinque aggiunti: incentivi edilizi,
assistenti sociali, cessazioni tardive INPS, registrazioni erronee/duplicate INPS,
rottamazioni. 55 calcoli e 48 fonti. I casi originari restano una sola volta.
Le stime econometriche sono attribuite agli autori: non sono nuove stime DVNS.
