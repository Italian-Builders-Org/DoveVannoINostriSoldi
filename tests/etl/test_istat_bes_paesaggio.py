"""BES_09-specific SDMX parsing, coverage and provenance checks, entirely offline."""
import copy
import csv
import io
import json
...
import istat_bes_paesaggio as bes


class BesPaesaggioTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_domain_units_and_edition_are_locked(self):
        for column, bad in [("UNIT_MEAS", "EURO"), ("DOMAIN", "BES_07"), ("EDITION", "2024"),
                            ("DATAFLOW", "IT1:DF_BES_TERRIT_7(1.0)")]:
