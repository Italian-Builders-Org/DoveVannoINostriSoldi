...
| Benchmark appalti davvero comparabili | Ranking ente su `main` ([#204](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/204), [#208](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/208), [#216](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/216)); concentrazione Top 1/Top 10 + HHI e dettaglio dei contratti nel perimetro esatto; filtro CPV con ricalcolo coerente; confronto conservativo tra Comuni con popolazione, attività e composizione CPV dichiarate (soglia minima 10 pari) | Sì | Alto | [#185](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/185) aperta; [#183](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/183): avvisi TED di agosto 2026 in `/appalti/ted`, separati da ANAC | `/enti/[codice]`, `/enti/[codice]/appalti`, `docs/research/ANAC_*` | Copertura confronti ampliata (soglia CPV 70%, v1.1); poi soglie e bunching per ente. Feedback: X-072, X-077, X-091, T-004, A-004. |
...
| Iniziativa | Copertura | Implementabile | Effort | Issue / PR | Dove | Prossimo passo |
|---|---|---|---|---|---|---|
| Servizi generali PA (COFOG GF01) | Dettaglio italiano GF0101–GF0108 2014-2024 integrato nello snapshot Eurostat; pagina dedicata e home non riducono più GF01 al debito | Sì | Basso | [#368](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/368) | `/spese/servizi-generali` | Review della PR. GF0107 resta distinto dagli interessi D.41; nessuna imputazione del secondo livello alle geografie con celle mancanti. |
| Cultura e tempo libero (COFOG GF08) | Totale Italia 2014-2024, serie e fonte; missione culturale OpenBDAP separata; dettaglio ufficiale GF0801–GF0806 sullo stesso importatore COFOG (#402) | Sì | Medio | [#367](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/367), [#402](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/402) | `/spese/cultura` | Sport resta approfondimento distinto; nessuna ripartizione stimata oltre le sottofunzioni pubblicate da Eurostat. |
| Difesa: funzione COFOG, missione Stato e tracker INVESTIMENTI | GF02 2014-2024 e missione CP A1 2017-2026 restano separati; aggiunta serie macroaggregato INVESTIMENTI dallo stesso CSV OpenBDAP AMPMA, riconciliata al totale di missione, con caveat NATO/missioni estere e link agli appalti Difesa | Sì | Basso | [#365](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/365), [#587](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/587) | `/spese/difesa` | Nessuna somma fra fonti; programmi pluriennali UPB restano solo provenance finché manca una tavola riusabile. |
...
| Sanità: valori reali, demografia, outcome | Conto economico, serie storica e grafico contabile su `main` ([#207](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/207) mergiata). Demografia e outcome assenti | Dipende | Alto | PR [#207](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/pull/207) mergiata: grafico contabile; non copre demografia/outcome | `/spese/sanita`, `/spese/sanita/storico` | Pilota #251: posti letto del Ministero al 1° gennaio 2023 affiancati al CE 2024, corpus/API/MCP e dettaglio regionale. Demografia per età, LEA/outcome e deflatore restano approfondimenti distinti. Feedback: X-009, X-021, X-022, X-035, A-003. |
| Assistente guidato con guardrail | Assistente deterministico su `main`, con confronto SIOPE fra due anni e blocco delle domande ambigue; niente LLM né voce | Sì | Alto | [#17](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/17) aperta | `/assistente`, `docs/ASSISTENTE.md` | Estendere intenti ed esempi. Privacy gate prima di qualsiasi modello generativo o voce. Feedback: X-005, X-015, X-016, X-102, T-010, T-027. |
...
| Calendario dei documenti programmatici | Registro 2026 e pagina Fonti in questa slice; nessun importo estratto dai documenti | Sì | Medio | [#260](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/260) aperta | `/fonti/calendario`, [FRESHNESS_AND_REFRESH.md](FRESHNESS_AND_REFRESH.md) | Mantenere distinti data osservata, finestra attesa e stato; aggiornare il ciclo solo da pagine ufficiali. |
...
| Politici: proposte firmate, iter e voto finale | Camera e Senato XIX: snapshot SPARQL verificati per ramo (atti, firme, iter/fasi, votazioni finali e voti nominali), contratti, sezione nel profilo e API | Sì | Medio | [#545](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/545) | `/politici`, `/api/politici/[id]/atti`, [PARLAMENTO_ATTI_VOTI.md](PARLAMENTO_ATTI_VOTI.md) | Review; poi votazioni non finali e emendamenti solo se richiesti. |
...
| Università e Ricerca: stanziamenti statali | MVP #101: due missioni RGS separate, 023 Università e 017 Ricerca, serie 2017-2026 dallo snapshot esistente; UI, filtro MCP e verifiche nella PR collegata | Sì | Basso | [#101](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/101), risolta dalla PR collegata | `/istruzione/universita-ricerca` | FFO/MUR, bilanci atenei e PRIN/PNRR richiedono issue e fonti proprie. La ricerca include enti non universitari; stanziamenti, non pagamenti. |
| Nuove verticali: clima e sport | Sport su `main`; ambiente: pagina EPEA 2016–2022 su snapshot esistente | Dipende | Fonte | [#86](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/86), [#83](https://github.com/Italian-Builders-Org/DoveVannoINostriSoldi/issues/83) | Nuove route | EPEA: settori separati, CEPA, serie storica e provenance su `/spese/ambiente`. RGS, PNRR e SAD/SAF restano follow-up della #86. Feedback: X-069, X-074, X-090. |
