...
const datasetDescriptors: DatasetDescriptorInput[] = [
  ...
  { id: "inps_integrazioni_salariali", title: "INPS · integrazioni salariali", summary: "Report annuale 2023 Ammortizzatori Sociali: lavoratori, domande e mensilità per regione, mese e tipo di intervento. Filtri table, year, period (mese italiano), region e interventionType opzionali.", sourceIds: ["inps-integrazioni-salariali"], freshness: "snapshot", filters: ["table", "year", "period", "region", "interventionType"], caveat: "Conteggi, non euro. Lavoratori, domande e mensilità sono nature distinte e non si sommano. Copertura chiavi non identica fra tabelle. Distinto da NASpI e Assegno Unico. Licenza cc-by. Nessuna lettura di adeguatezza o merito." },
