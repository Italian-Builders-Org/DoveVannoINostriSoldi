...
test("SIOPE refresh measurements vary without changing other corpus contributions", () => {
  ...
  assert.equal(INTEGRATED_CORPUS_CONTRACT.sourceRows - before.rows, 18_056_224);
  assert.equal(INTEGRATED_CORPUS_CONTRACT.publicRows - before.rows, 5_073_878);
  assert.equal(INTEGRATED_CORPUS_CONTRACT.sourceBytes - before.bytes, 3_497_087_967);
