...
class ReaderTests(unittest.TestCase):
    ...
    def test_55_decimal_calculations(self):
        self.assertEqual(len(REPORT['calculations']),55)
    ...
    def test_csv_contains_exactly_22_cases(self):
        rows=list(csv.DictReader(io.StringIO((ROOT/builder.CSV).read_text(encoding='utf-8-sig'))));self.assertEqual(len(rows),22)
